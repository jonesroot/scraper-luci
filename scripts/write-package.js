...
async function writePackageJson() {
  ...
  if (!libExists) {
    console.error('@jonesroot/scraper:', 'Lib folder not found after compiling TypeScript')
    process.exit(1)
  }
  console.log('@jonesroot/scraper:', 'Writing \'package.json\' file...')
  ...
  } else console.warn('@jonesroot/scraper:', 'CJS folder not found')
  ...
  } else console.warn('@jonesroot/scraper:', 'ESM folder not found')
  ...
  if (!typesExists && !libEsmExists && !libCjsExists) {
    console.error('@jonesroot/scraper:', 'No compiled TypeScript files found')
    process.exit(1)
  }
}
